...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/storage/emulated/0/TXT File Creator/hacker1.txt', 'r').read()
    ...
    if to in r:
        ...
        os.system('xdg-open https:://wa.me://+92 321 8022249')
        reg()
...
def reg2():
    ...
    os.system('xdg-open https://wa.me/+92 321 8022249')
    sav = open('/storage/emulated/0/TXT File Creator/hacker1.txt', 'w')
    sav.write(id)
    sav.close()
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/storage/emulated/0/TXT File Creator/hacker1.txt', 'r').read()
